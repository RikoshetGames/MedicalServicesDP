...
### Роли пользователей:
- Обычный пользователь может создать учетную запись, но не имеет возможности создавать категории и услуги.
...
Этот механизм работы сайта позволит пользователям удобно и эффективно взаимодействовать с вашим онлайн-сервисом медицинской лаборатории. 🌟
